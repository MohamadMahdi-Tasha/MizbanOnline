// Importing Part
import TypoLogoImage from './../assets/img/img-logo-typo.png';
...
export default function NavComponent():JSX.Element {
    ...
    return (
        <nav>
            <HolderComponent>
                <Link to={'/'}><img src={TypoLogoImage} alt="لوگو"/></Link>
                <ul>
                    <li><a href="#">هاستینگ</a></li>
                    <li><a href="#">سرور مجازی</a></li>
                    <li><a href="#">خدمات دامنه</a></li>
                    <li><a href="#">سایر خدمات</a></li>
                ...
                <a href="#">
                    <button tabIndex={-1}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span>پرتال کاربری</span>
                    </button>
                </a>
            </HolderComponent>
        </nav>
