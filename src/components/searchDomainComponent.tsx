            ...
            <div>
                ...
                <form action="#" className={'bg-aliceBlue rounded-[12px] px-[24px] py-[10px] flex items-center gap-[10px]'}>
                    ...
                    <div className={'flex gap-[5px]'}>
                        <button className={'w-[50px] h-[50px] rounded-[11px] flex items-center justify-center bg-myGreen'} type={"button"}>
                        ...
                        <button className={'w-[50px] h-[50px] rounded-[11px] flex items-center justify-center bg-themeBlue'} type={"button"}>
