...
export default function SearchDomainComponent():JSX.Element {
    ...
    return (
        <>
            <img className={'lg:w-auto w-[20%]'} src={Image} alt="ثبت دامنه"/>
            <div>
                <h6 className={'font-semibold text-[20px] text-darkBlue mb-[8px]'}>جستجو و ثبت دامنه</h6>
                <p className={'lg:text-[15px] text-[11px] font-normal text-outerSpace mb-[22px]'}>
                ...
                <form action="#" className={'bg-aliceBlue rounded-[12px] px-[24px] py-[10px] flex lg:flex-row flex-col items-center gap-[10px]'}>
                    <input className={'bg-transparent lg:p-0 py-[10px] w-full outline-0 placeholder:text-[15px] placeholder:font-normal placeholder:text-outerSpace text-darkBlue'} type="text" placeholder={'دامنه خود را جستجو کنید'} required />
                    <div className={'flex lg:flex-row flex-col lg:gap-[5px] gap-[15px] lg:w-auto w-full'}>
                        <button className={'lg:w-[50px] w-full h-[50px] rounded-[11px] flex items-center justify-center bg-myGreen'} type={"button"}>
                        ...
                        <button className={'lg:w-[50px] w-full h-[50px] rounded-[11px] flex items-center justify-center bg-themeBlue'} type={"button"}>
